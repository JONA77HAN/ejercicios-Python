...
# del producto seguido de su precio unitario con 6 dígitos enteros 
...
print(f'{producto}, {precio} el kilo:\nLlevando {unidades} unidades el precio es de ${precio*unidades}.-')
